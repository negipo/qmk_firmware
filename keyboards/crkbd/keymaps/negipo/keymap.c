...
#define KC_T1 LGUI(KC_1)
#define KC_T2 LGUI(KC_2)
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  //|------+------+------+------+------+------|                |------+------+------+------+------+------|
<<<<<<< 2861f2c44ae3d09e7d5ae057225e5b2769b81e5d
      LCTL,    F1,    F2,    F3,    F4,    F5,                   LEFT,   DOWN,    UP, RIGHT, XXXXX, XXXXX,\
  //|------+------+------+------+------+------|                |------+------+------+------+------+------|
       LSFT,   F11,   F12,   F13,   F14,   F15,                  ADOWN,   AUP,GADOWN,  GAUP,   F20, XXXXX,\
=======
      LCTL,    F1,    F2,    F3,     UP,    F5,                  XXXXX,     4,     5,     6, XXXXX, XXXXX,\
  //|------+------+------+------+------+------|                |------+------+------+------+------+------|
       LSFT,   F11,   F12,  LEFT,  DOWN, RIGHT,                      0,     1,     2,     3,   F20, XXXXX,\
>>>>>>> Update num and arrow
  //|------+------+------+------+------+------+------|  |------+------+------+------+------+------+------|
                                  LGUI, LOWER,   SPC,      ENT, RAISE, RALT \
                              //`--------------------'  `--------------------'
  ),
