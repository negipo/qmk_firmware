...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [1] = LAYOUT_split(
        ...
        KC_F2, LCTL(KC_TAB), KC_S1, KC_S2, KC_S3, KC_S4, KC_S5, KC_S6, KC_S7, KC_S8, KC_S9, KC_S0, KC_SBSLASH, KC_ENTER,
        KC_F1, KC_LSFT, KC_SBSLASH, KC_SGRAVE, KC_GRAVE, KC_SEQUAL, KC_SMINUS, KC_MINUS, KC_EQUAL, KC_LBRC, KC_RBRC, KC_BSLASH, KC_RSFT, KC_TRNS,
