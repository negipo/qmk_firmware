...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [0] = LAYOUT_split(/* Base */
                 KC_F1, KC_ESC, KC_Q, KC_W, KC_E, KC_R, KC_T, KC_Y, KC_U, KC_I, KC_O, KC_P, KC_LBRC, KC_RBRC, KC_BSPC,
                 ...
                 KC__MUTE, KC_LGUI, KC_LALT, KC_LGUI, LT(1, KC_SPACE), KC_RGUI, KC_RALT, KC_BSLASH, LT(1, KC_GRAVE)),
