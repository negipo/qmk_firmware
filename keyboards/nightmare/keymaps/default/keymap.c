...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [0] = LAYOUT_split(/* Base */
                 RESET, KC_ESC, KC_Q, KC_W, KC_E, KC_R, KC_T, KC_Y, KC_U, KC_I, KC_O, KC_P, KC_LBRC, KC_RBRC, KC_BSLASH,
                 KC__VOLUP, KC_CTLTB, KC_A, KC_S, KC_D, KC_F, KC_G, KC_H, KC_J, KC_K, KC_L, KC_SCLN, KC_QUOTE, KC_BSPC,
                 KC__VOLDOWN, KC_LSFT, KC_Z, KC_X, KC_C, KC_V, KC_B, KC_N, KC_M, KC_COMMA, KC_DOT, KC_SLSH,KC_SFTMI, KC_EQUAL,
                 KC__MUTE, KC_LGUI, KC_LALT, KC_LGUI, KC_SPTWO, KC_ENONE, KC_RGUI, KC_RALT, KC_GRAVE),

    [1] = LAYOUT_split(
        RESET, KC_TRNS, KC_1, KC_2, KC_3, KC_4, KC_5, KC_6, KC_7, KC_8, KC_9, KC_0, KC_MINUS, KC_EQUAL, KC_DEL,
        KC_TRNS, KC_TRNS, KC_S1, KC_S2, KC_S3, KC_S4, KC_S5, KC_S6, KC_S7, KC_S8, KC_S9, KC_S0, KC_SMINUS, KC_SEQUAL,
