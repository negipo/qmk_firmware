...
#define KC_SLBRC LSFT(KC_LBRC)
#define KC_SRBRC LSFT(KC_RBRC)
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [1] = LAYOUT_split(
        ...
        KC_F2, LCTL(KC_TAB), KC_S1, KC_S2, KC_S3, KC_S4, KC_S5, KC_S6, KC_S7, KC_S8, KC_S9, KC_S0, KC_BSLASH, KC_ENTER,
        KC_F1, KC_SBSLASH, KC_BSLASH, KC_SGRAVE, KC_GRAVE, KC_SEQUAL, KC_SMINUS, KC_MINUS, KC_EQUAL, KC_LBRC, KC_RBRC, KC_SLBRC, KC_SRBRC, KC_TRNS,
        KC_TRNS, KC_TRNS, KC_LALT, KC_LGUI, KC_SPACE, KC_SPACE, KC_RALT, KC_TRNS, KC_TRNS),
