...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    LAYOUT(
		...
		KC_CTLTB,   KC_A,     KC_S,     KC_D,   KC_F,    KC_G,          KC_H,   KC_J,     KC_K, KC_L,    KC_SCLN, KC_QUOTE,
		KC_SFTEQL,  KC_Z,     KC_X,     KC_C,   KC_V,    KC_B,          KC_BSPC,  KC_N,     KC_M, KC_COMM, KC_DOT,  KC_SLSH, KC_SFTMI,
		KC__MUTE,  KC_LALT,           KC_LGUI, LT(1, KC_SPACE),	          LT(1, KC_ENTER), KC_RGUI,              LT(2, KC_BSLASH), LT(2, KC_GRAVE)
    ),

    LAYOUT(
		KC_GRV,    KC_1,   KC_2,   KC_3,   KC_4,    KC_5,          KC_6,   KC_7,    KC_8,     KC_9,   KC_0,   KC_MINUS,   KC_EQUAL,
		KC_CTLTB,   KC_S1,   KC_S2,   KC_S3,   KC_S4,    KC_S5,          KC_S6,   KC_S7,    KC_S8,   KC_S9,  KC_S0,   KC_SBSLASH,
		KC_SFTEQL, KC_SBSLASH,KC_SGRAVE,KC_GRAVE,   KC_SEQUAL, KC_SMINUS,          KC_BSPC,   KC_TRNS,  KC_TRNS, KC_TRNS,KC_TRNS,KC_BSLASH, KC_SFTMI,
		BL_TOGG,   BL_STEP,                         KC_LGUI,    KC_SPACE,	        KC_ENTER,   KC_RGUI,                                     KC_TRNS,   KC_TRNS
    ),

    LAYOUT(
		RESET,  KC_F1,      KC_F2,      KC_F3,      KC_F4,       KC_F5,             KC_F6,      KC_F7,     KC_F8,    KC_F9,    KC_F10,   KC_MINS,  KC_EQL,
